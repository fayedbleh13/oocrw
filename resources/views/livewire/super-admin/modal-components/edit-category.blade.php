<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="editCategoryModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">Edit this Category</h5>
                    ...
                    <button type="submit" wire:click.prevent="updateCategory()" class="btn bg-gradient-primary">Update</button>
                    </div>
                </div>
