<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="editAmenityModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <input type="hidden" wire:model="amenities_id">
                    ...
                    <button type="submit" wire:click.prevent="updateAmenity()" class="btn bg-gradient-primary">Update</button>
                    </div>
                </div>
