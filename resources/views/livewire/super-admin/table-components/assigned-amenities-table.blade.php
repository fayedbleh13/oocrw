<div>
            ...
            <tr>
                ...
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                    <a wire:click.prevent="sortBy('amenities')" href="#" role="button" >Assigned Amenities
                        @include('livewire.super-admin.table-components._sort-icon', ['field' => 'amenities'])
                    </a>
                </th>
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
            ...
            <tbody class="table-bordered">
                   ...
                   @foreach ($amenitya as $amen )
                    <tr>
                        ...
                        <td align="center">
                            {{ date_format($amen->updated_at,'d M Y') }} {{ date('h:i A', strtotime($amen->updated_at)) }}
                        </td>
    ...
    @include('livewire.super-admin.modal-components.edit-assigned-amenities')
</div>
