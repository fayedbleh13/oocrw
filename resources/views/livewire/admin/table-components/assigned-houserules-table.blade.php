<div>
            ...
            <tr>
                ...
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                    <a wire:click.prevent="sortBy('house_rules')" href="#" role="button" >House-rules
                        @include('livewire.admin.table-components._sort-icon', ['field' => 'house_rules'])
                    </a>
                </th>
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
    ...
    @include('livewire.admin.modal-components.edit-houserules')
    @include('livewire.admin.modal-components.edit-assigned-houserules')
</div>
