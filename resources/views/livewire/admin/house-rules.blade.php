<div>
           ...
           <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="houserules" role="tabpanel" aria-labelledby="houserules-tab">
                        @livewire('admin.table-components.house-rules-table')
                    </div>
                    <div class="tab-pane fade" id="assigned" role="tabpanel" aria-labelledby="assigned-tab">
                        @livewire('admin.table-components.assigned-houserules-table')
                    </div>
                </div>
           </div>
       </div>
   ...
   @livewire('admin.modal-components.add-houserules')
   @livewire('admin.modal-components.assign-houserules')
