<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="viewReservationModal2" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="Approved" class="form-control" placeholder="Status" readonly disabled>
                                        @endif
