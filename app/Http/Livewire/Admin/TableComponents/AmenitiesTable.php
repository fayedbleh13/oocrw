...
class AmenitiesTable extends Component
{
    ...
    public function updateAmenity()
    {
        if ($this->amen_id) {
            ...
            return redirect('/admin/amenities')->with('msg', 'Amenity has been updated succesfully');
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.table-components.amenities-table', compact('amenitya'))->layout('layouts.admin');
    }
}
