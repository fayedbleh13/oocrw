...
class AssignedHouserulesTable extends Component
{
    ...
    public function reAssignHouserules()
    {
        if ($this->houserules_id) {
            ...
            return redirect('/admin/house-rules')->with('msg', 'Houserules has been re-assigned succesfully');
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.table-components.assigned-houserules-table', compact('house_rules'))->layout('layouts.admin');
    }
}
