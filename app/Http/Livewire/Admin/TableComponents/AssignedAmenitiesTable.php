...
class AssignedAmenitiesTable extends Component
{
    ...
    public function editAmenities()
    {
        if ($this->amen_id) {
            ...
            return redirect('/admin/amenities')->with('msg', 'Update and re-assigned amenities successful');
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.table-components.assigned-amenities-table', compact('amenitya'))->layout('layouts.admin');
    }
}
